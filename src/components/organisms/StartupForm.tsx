...
import { PubkyLogo, RefreshIcon } from "@/components/atoms";
import { PubkyInput } from "@/components/molecules";
import { useUIStore } from "@/stores/useUIStore";
import { useInitialize, usePreviousPubkyKeys, useLastPubky } from "@/hooks";
...
export function StartupForm() {
  ...
  const { data: previousKeys = [] } = usePreviousPubkyKeys();
